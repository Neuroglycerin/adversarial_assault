...
from slim.layers.custom_utils import tf_median_pool
...
tf.flags.DEFINE_integer(
    'num_aug', 16, 'Number of augmented repetitions of the image to each net.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        model_stack.add('inception_resnet_v2_medpool', 'models/ens_adv_inception_resnet_v2', im_size=299)
        model_stack.add('xception_multiscale2_flab', 'models/xception_multiscale2_flab_255_adv', im_size=255)
        ...
        # Collect logits
        x_filtered = tf_median_pool(x_input, [4, 4])
        logits_stack = update_logits(x_filtered)
        ...
        with tf.Session() as sess:
            ...
            num_samples_shown = 0
            last_report_nsamp = 0
            logging.info('Starting to generate labels after {} seconds'.format(
