...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        def update_logits(x):
            ...
            pre_resize_fn = lambda y: augment_batch_pre_resize(y, source_space='flab')
            # Then we transform back to RGB space before adding pixel-wise noise
            post_resize_fn = lambda y: \
                augment_batch_post_resize(colorspace_transform.tf_flab_to_rgb(y))
