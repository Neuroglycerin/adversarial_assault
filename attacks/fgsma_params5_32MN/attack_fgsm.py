...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_224', im_size=224)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_192', im_size=192)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_160', im_size=160)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_128', im_size=128)
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_224', im_size=256)
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_192', im_size=224)
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_160', im_size=192)
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_128', im_size=160)
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_224', im_size=256)
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_192', im_size=224)
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_160', im_size=192)
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_128', im_size=160)
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_224', im_size=256)
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_192', im_size=224)
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_160', im_size=192)
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_128', im_size=160)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_224', im_size=256)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_192', im_size=224)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_160', im_size=192)
        model_stack.add('mobilenet_v1_025', 'models/mobilenet_v1_025_128', im_size=160)
