...
cp -r "${MODELS_SOURCE_DIR}"/inception_v3 "${MODELS_OUT_DIR}"
...
cp -r "${MODELS_SOURCE_DIR}"/mobilenet_v1_025_224 "${MODELS_OUT_DIR}"
cp -r "${MODELS_SOURCE_DIR}"/mobilenet_v1_025_192 "${MODELS_OUT_DIR}"
cp -r "${MODELS_SOURCE_DIR}"/mobilenet_v1_025_160 "${MODELS_OUT_DIR}"
cp -r "${MODELS_SOURCE_DIR}"/mobilenet_v1_025_128 "${MODELS_OUT_DIR}"
