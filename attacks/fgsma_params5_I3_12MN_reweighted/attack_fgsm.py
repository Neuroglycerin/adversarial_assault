...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        model_stack.add('inception_v3', 'models/inception_v3', im_size=299, weight=1.)
        num_mobnets = 12
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_224', im_size=224, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_192', im_size=192, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_160', im_size=160, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_100', 'models/mobilenet_v1_100_128', im_size=128, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_224', im_size=224, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_192', im_size=192, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_160', im_size=160, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_075', 'models/mobilenet_v1_075_128', im_size=128, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_224', im_size=224, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_192', im_size=192, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_160', im_size=160, weight=(1. / math.sqrt(num_mobnets)))
        model_stack.add('mobilenet_v1_050', 'models/mobilenet_v1_050_128', im_size=128, weight=(1. / math.sqrt(num_mobnets)))
        ...
        label_weights_sorted = label_weights_sorted / \
            tf.reduce_sum(label_weights_sorted, axis=-1, keep_dims=True)
        # 1 x 1000
