...
tf.flags.DEFINE_float(
    'update_decay_rate', 0.95, 'Maximum size of adversarial perturbation.')

tf.flags.DEFINE_float(
    'rprop_increment', 1.2, 'Maximum size of adversarial perturbation.')

tf.flags.DEFINE_float(
    'rprop_decrement', 0.75, 'Maximum size of adversarial perturbation.')
